...
public class AppointmentCreatorController implements Initializable {
	...
	public void appointmentSavePress(ActionEvent event) {
		 ...
		 * TreeItem<String> savePosition =
		 * chooseCategory.getSelectionModel().getSelectedItem(); TreeItem<String>
		 * newItem = new TreeItem<String>("Termin: " + AppointmentTitle.getText(), new
		 * ImageView(icon)); CategoriesController.insertCategoryByCreator(savePosition,
		 * newItem); }
		 */
