...
public class AppointmentCreatorController implements Initializable
{
	...
	@FXML
	private CheckBox insertCategory;
	@FXML
	private ChoiceBox<TreeItem<String>> chooseCategory = new ChoiceBox<>();
	ArrayList<TreeItem> mainCategories;
	...
	public void initialize(URL location, ResourceBundle resources)
	{
		...
		chooseCategory.getItems().add(CategoriesController.getMainCategories().get(0));
		chooseCategory.getItems().add(CategoriesController.getMainCategories().get(1));
		chooseCategory.getItems().add(CategoriesController.getMainCategories().get(2));
		chooseCategory.getItems().add(CategoriesController.getMainCategories().get(3));
	}
    }
