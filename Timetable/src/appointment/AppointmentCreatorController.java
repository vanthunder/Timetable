...
public class AppointmentCreatorController implements Initializable
{
	...
	public void appointmentSavePress(ActionEvent event) 
	{
		...
		Appointment serObj = new Appointment("Stupid Appointment", null, null, false, false, 0, 0, "Some stupid text", false, null, 0, null, false);
		...
		boolean allDay = AppointmentAllDay.getState();
		...
		boolean regularlyOnOff = AppointmentRegularlyOnOff.getState();
		int regularlyType;
		int regularlyAmount;
		String description;
